...
> **📘 통합 파이프라인 요약**
>
> 프로젝트의 전체 데이터 흐름과 아키텍처에 대한 상세 설명은 [BindQ Wiki](https://github.com/peussd55/BindQ/wiki/BindQ-%ED%86%B5%ED%95%A9-%ED%8C%8C%EC%9D%B4%ED%94%84%EB%9D%BC%EC%9D%B8-%EC%9A%94%EC%95%BD) 페이지를 참고하세요.
